...
public class Table extends Component {
    ...
    private Map<Class<? extends Object>, TableCellRenderer> defaultRendererMap = new HashMap<Class<? extends Object>, TableCellRenderer>();
    ...
    protected void doRender() {
        ...
        for (int columnIndex = 0; columnIndex < columnCount; ++columnIndex) {
            ...
            if (renderer == null) {
                Class<? extends Object> columnClass = model.getColumnClass(tableColumns[columnIndex].getModelIndex());
     ...
     * @return the <code>TableCellRenderer</code>
     */
    public TableCellRenderer getDefaultRenderer(Class<? extends Object> columnClass) {
     ...
     * @param newValue the <code>TableCellRenderer</code>
     */
    public void setDefaultRenderer(Class<? extends Object> columnClass, TableCellRenderer newValue) {
        invalidate();
        if (newValue == null) {
