...
public class ContainerContextTest extends Column {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6456801795688616453L;
	...
	private class CookiesTableModel extends AbstractTableModel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2048246163033540507L;
    ...
    implements TableCellRenderer {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 7425868811136227230L;
    ...
    public ContainerContextTest() {
        ...
        setCookieButton.addActionListener(new ActionListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 7309274968111654190L;
        ...
        refreshCookiesButton.addActionListener(new ActionListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -947725485478382882L;
